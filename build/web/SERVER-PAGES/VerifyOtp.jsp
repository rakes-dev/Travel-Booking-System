...
catch(Exception ex)
{
                ...
                <script>
                    ...
                    location.href="http://localhost:8084/Travel_Booking_System/STATIC-PAGES/login.html";
                </script>
                <%  
}
            ...
            else
            {
                   ...
                   <a href="http://localhost:8084/Travel_Booking_System/sessionLogOut">Sign out</a>
                   <h3>
                    <%
            }   
            %> 
        <h2>THIS IS OTP VERIFICATION PAGE BEFORE LOGGING IN COMPLETELY!</h2>
        <form name="frmOTP" method="POST" action="http://localhost:8084/Travel_Booking_System/SERVER-PAGES/VerifyOtp.jsp">
        <div>
            <table border="1">
                <thead>
