    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                    ...
                    response.sendRedirect("http://localhost:11756/Travel_Booking_System/SERVER-PAGES/LoginOtpVerification.jsp");
            ...
            {
                response.sendRedirect("http://localhost:11756/Travel_Booking_System/STATIC-PAGES/WrongPass.html");
